...
public class RobotMap
 {
    ...
    public static void init() {
        ...
        pneumaticSubsystemLoaderCylinder1 = new DoubleSolenoid(1, 2);      
	
        
        pneumaticSubsystemPushCylinder = new DoubleSolenoid(5, 6);      
	
        
        pneumaticSubsystemCompressor1 = new Compressor(0);
	
        
        pneumaticSubsystemLoadCylinder2 = new DoubleSolenoid(7, 0);      
	
        
        pneumaticSubsystemClampCylinder = new DoubleSolenoid(3, 4);      
